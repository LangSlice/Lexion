...
Refer to [.claude/framework_guidelines.md](.claude/framework_guidelines.md) for:
- SolidJS best practices and reactivity rules
- Component structure and prop management
- Common pitfalls to avoid
- Project-specific architecture (Stores, Routing, Icons)